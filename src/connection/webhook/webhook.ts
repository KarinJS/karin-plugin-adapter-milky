...
logger.info(`[${AdapterName}] ${logger.yellow('WebHook 访问地址')}: ${logger.green(`http://127.0.0.1:${process.env.HTTP_PORT}${RouterPath}/webhook?access_token=${Cfg.getConfig.webhookToken || ''}`)}`)
